                          ...
                          [
                            _vm.mergedConfig.showVal
                              ? _c(
                                  "span",
                                  {
                                    staticClass: "capsule-item-val",
                                    style:
                                      "right:-" +
                                      ("" + _vm.capsuleValue[index]).length * 7 +
                                      "px"
                                  },
                  ...
                  _c(
                    ...
                    _vm._l(_vm.labelData, function(label, index) {
                      return _c(
                        ...
                        {
                          key: label + index,
                          style: _vm.calcUnitLabelStyle(index)
                        },
                        [_vm._v(_vm._s(label))]
                      )
                    }),
